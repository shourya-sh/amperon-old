...
export const circuitComponents: CircuitComponent[] = [
  ...
  // Passive Components
  {
    ...
    type: 'resistor',
    name: 'Resistor',
    description: 'Resists the flow of electric current. The colored bands show its resistance value. Higher resistance = less current flows.',
    symbol: 'Ω',
    category: 'passive',
    icon: 'resistor',
    connections: 2,
  ...
  },
  {
    ...
    type: 'capacitor',
    name: 'Capacitor',
    description: 'Stores electrical energy temporarily, like a tiny rechargeable battery. Can smooth out voltage changes in a circuit.',
    symbol: '||',
    category: 'passive',
    icon: 'capacitor',
    connections: 2,
  ...
  },
  {
    ...
    type: 'transistor',
    name: 'Transistor',
    description: 'An electronic switch or amplifier. A small current controls a much larger current - like a valve!',
    symbol: '⋔',
    category: 'active',
    icon: 'transistor',
    connections: 3,
  ...
  // Output Devices
  {
    ...
    type: 'lightbulb',
    name: 'Light Bulb',
    description: 'Produces light when current flows through its filament. Gets hot - that\'s how it makes light!',
    symbol: '💡',
    category: 'output',
    icon: 'lightbulb',
    connections: 2,
  ...
  },
  {
    ...
    type: 'buzzer',
    name: 'Buzzer',
    description: 'Makes a sound when electricity flows through it. Great for alarms and notifications!',
    symbol: '🔔',
    category: 'output',
    icon: 'buzzer',
    connections: 2,
  ...
  // Measurement
  {
    ...
    type: 'voltmeter',
    name: 'Voltmeter',
    description: 'Measures the voltage (electrical pressure) between two points in a circuit.',
    symbol: 'V',
  ...
  },
  {
    ...
    type: 'ammeter',
    name: 'Ammeter',
    description: 'Measures the current (flow of electricity) through a circuit.',
    symbol: 'A',
    category: 'measurement',
    icon: 'ammeter',
    connections: 2,
  ...
  },
  {
    ...
    type: 'ground',
    name: 'Ground',
    description: 'The reference point (0 volts) in a circuit. All voltages are measured relative to ground.',
    symbol: '⏚',
    category: 'connection',
    icon: 'ground',
    connections: 1,
